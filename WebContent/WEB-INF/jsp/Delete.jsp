        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="/BankAppTemplate/app/BankAccount/home/Update">Update Account</a>                           </a>
                </div>
            </li>
        </ul>
    </nav>
    <form action="/BankAppTemplate/app/BankAccount/delete" class="form-box1" method="post">
        <h2 class="new-heading">Delete AccountID</h2>
        <div class="row">
        ...
        <button type="submit" class="btn btn-primary sbtn1">Delete</button>
    </form>
