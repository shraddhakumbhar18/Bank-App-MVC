...
<head>
    ...
    <form action= "/BankAppTemplate/app/BankAccount/withdrawn" class="form-box" method= "post">
            <h2 class="new-heading">Withdrawl Amount</h2>
        <div class="row">
        ...
        <button type="submit" class="btn btn-primary sbtn">Withdraw</button>
    </form>
